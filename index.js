...
const transactionEndingRequired = require('./lib/rules/transaction-ending-required');
...
module.exports = {
  configs: {
    recommended: {
      ...
      rules: {
        ...
        'cubyn/transaction-ending-required': 'error',
  ...
  rules: {
    ...
    'transaction-ending-required': transactionEndingRequired,
  },
};
